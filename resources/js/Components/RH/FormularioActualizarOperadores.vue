...
watch(() => props.operador, async (newVal) => {
    ...
    form.numLicencia = newVal.numLicencia;
    form.vigenciaLicencia = newVal.vigenciaLicencia;
    form.numINE = newVal.numINE;
    form.vigenciaINE = newVal.vigenciaINE;
    form.ultimoContrato = newVal.ultimoContrato;
    ...
    form.convenioPa = newVal.idConvenioPago;
    form.constanciaSF = newVal.constanciaSF === 1;
    form.cursoSemovi = newVal.cursoSemovi === 1;
    form.cursoPsicologico = newVal.cursoPsicologico === 1;
    form.constanciaSemovi = newVal.constanciaSemovi === 1;
...
const update = async () => {
    ...
    form.post(route('rh.actualizarOperador', form.idOperador), {
        onSuccess: () => {
            close();
            ...
            /* numeroCError.value = ''; */
            directivoError.value = '';
            vigenciaINEError.value = '';// Limpia los campos de incapacidad
        }
    });
};
