...
const save = async () => {
    ...
    telEmerError.value = validateNumeroTelefono(form.telEmergencia) ? '' : 'Número de telefono no válido';
    ...
    if (
        ...
        codigoPError.value || calleError.value || estadoError.value || numeroCError.value || vigenciaINEError.value || totalDiasVacError.value || diasRestantesError.value
    ) {
        return;
    }
