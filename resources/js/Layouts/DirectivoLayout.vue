...
import TopContentDir from '../Components/Directivo/TopContentDir.vue';
import OpcionesNavDir from '../Components/Directivo/OpcionesNavDir.vue';
...
<template>
  <div class="flex flex-col h-screen bg-gray-100"><!-- Es lo que está de fondo fondo -->
    ...
    <TopContentDir :usuario="props.usuario" /> <!--LLama al componente TopContent-->
    ...
    que afecta al menu y el encabezado -->
      ...
      <div class="p-2 bg-gray-800 w-full md:w-60 flex flex-col" id="sideNav"> <!--Color de la barra de menu-->
        <nav>
          ...
          <OpcionesNavDir /> <!--LLama al componente OpcionesNav-->
